...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        /* Ảnh bìa chung */
         .book-cover-img {
             width: 100%; height: 260px; /* Chiều cao nhỏ hơn chút cho trang user */_setPassword(_password("password"), "MgkKBhE=");
_click(_submit("Login"));
_click(_row("Password"));
_setPassword(_password("password"), "MgkKEQBU");
_click(_submit("Login"));
_setValue(_textbox("q"), "100");
_setValue(_textbox("q[1]"), "111");
_setValue(_textbox("q[2]"), "222");
_click(_button("Add"));
