    ...
    public partial class quenmatkhau : System.Web.UI.Page
    {
        ...
        private void SendConfirmationEmail(string toEmail, string maXacNhan)
        {
            ...
            <div style='font-family: Arial, sans-serif; line-height: 1.6;'>
                ...
                message.Body = body;
                message.IsBodyHtml = true;
                message.From = new MailAddress("webebookrecreate@gmail.com");
        ...
        */
        ...
        {
            string path = Server.MapPath("~/App_Data/error.log");
            System.IO.File.AppendAllText(path, DateTime.Now + " - " + v + Environment.NewLine);
        }
